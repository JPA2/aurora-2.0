...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 23, 2021 at 10:25 PM
...
(1, NULL, NULL, NULL, NULL, NULL, 'NOTICE', 'Undefined variable: form', '12-23-2021 4:15:22', 5, NULL, '8', 'C:\\aurora\\Aurora-Laminas\\module\\User\\view\\user\\user\\login.phtml', '7', NULL, 0),
(2, 1, 'testing', NULL, 'Joey', 'Smith', 'INFO', 'User testing logged in.', '12-23-2021 4:15:22', 6, NULL, NULL, NULL, NULL, NULL, 0),
(3, NULL, NULL, NULL, NULL, NULL, 'NOTICE', 'Trying to get property \'disableRegistration\' of non-object', '12-23-2021 4:24:16', 5, NULL, '8', 'C:\\aurora\\Aurora-Laminas\\module\\User\\view\\user\\register\\index.phtml', '9', NULL, 0),
(4, NULL, NULL, NULL, NULL, NULL, 'NOTICE', 'Undefined variable: form', '12-23-2021 4:24:16', 5, NULL, '8', 'C:\\aurora\\Aurora-Laminas\\module\\User\\view\\user\\register\\index.phtml', '16', NULL, 0);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='will join user_profile table on id';
...
(1, 'testing', 'jsmith@webinertia.net', '$2y$10$ncO3bgCRcWaCdeINBffN4eDBAuRnhden9eZd6hXQIttrGc1hjoFlO', 'admin', '', '2021-11-08 22:26:20', 1, 1, NULL, NULL),
...
(25, 'testingdelete2', 'testingdelete2@webinertia.net', '$2y$10$u/jzYFjmpq8CLxGO6W1RWOVCqvDgIQgrS912uO8eTxHcBmhNTAtR6', 'user', NULL, '12-20-2021 6:37:35', 0, 0, '$2y$10$3oxsZCo.zh5czNqZtCxX/.4l28k8ZdZ0FbwdUQ3te9yHqAKJ0.ThO', NULL),
(26, 'testingdelete3', 'testingdelete3@webinertia.net', '$2y$10$x9rHCFzCNDmNVCKBEsFtkeTLo6isk4PjyIlQlyczTuZrgSbV0BSq6', 'user', NULL, '12-20-2021 6:38:30', 0, 0, '$2y$10$hwZQon6Vc71x2OsROUYMF.j9JG6dV1Ob26eHs22gC90DzXJQFn3mC', NULL),
(27, 'testingdelete4', 'testingdelete4@webinertia.net', '$2y$10$SgnChknbNwcK8XPT4Ngb0O8j58spICvR/QFu0Ixn8U33XQmMiZgU6', 'user', NULL, '12-20-2021 6:39:39', 0, 0, '$2y$10$CC5VHmVYs3X.qYd/t3RRG.q5nS2kIUj2V524ONpWq4PSu00YSWtgO', NULL),
(28, 'Evolvecms', 'firecms@fireevolve.com', '$2y$10$9AC5q2opUcocoIW.BlvoiOvcrIx.cv50Qh4wFE2EegsQ5cZaFRqvq', 'user', NULL, '12-23-2021 4:24:14', 0, 0, '$2y$10$VM8AEPL7X5zicTeptiEdaexAP81BE7Qlam04JjDYcNQoG9lXtY4ni', NULL);
...
(1, 1, 'Joey', 'Smith', '/user/profile/avatars/jsmith.png', 46, '02/13/1975', 'male', 'white', 'This is a bio entry for my profile. its just some test data so that its not empty..');
